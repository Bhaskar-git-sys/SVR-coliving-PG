...
function generateRooms(): Room[] {
  const rooms: Room[] = [];
  const types: RoomType[] = ['single', 'double', 'double', 'triple', 'triple', 'quad', 'quad', 'double'];
...
function defaultSettings(): PGSettings {
  return {
    ...
    pricing: { single: 15000, double: 10000, triple: 8000, quad: 6500 },
    advanceRules: { single: 30000, double: 20000, triple: 16000, quad: 13000 },
