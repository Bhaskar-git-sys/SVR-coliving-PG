  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        <FormField icon={UserIcon} label="Full Name" value={form.name} onChange={(v) => update('name', v)} placeholder="John Doe" required />
        <FormField icon={Phone} label="Mobile" value={form.mobile} onChange={(v) => update('mobile', v)} placeholder="9876543210" required />
      </div>
