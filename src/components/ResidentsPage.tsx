            ...
            return (
              ...
              >
                ...
                <div className="mt-3 pt-3 border-t border-navy-700 grid grid-cols-3 gap-2 text-center">
                  <div>
                    <p className="text-navy-400 text-xs">Rent</p>
                    <p className="text-white text-sm font-semibold flex items-center justify-center">
                      <IndianRupee className="w-3 h-3" />{resident.rent}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-emerald-400 text-sm font-semibold flex items-center justify-center">
                      <IndianRupee className="w-3 h-3" />{resident.paid}
                    </p>
                  </div>
                  <div>
                    <p className="text-navy-400 text-xs">Balance</p>
                    <p className={`text-sm font-semibold flex items-center justify-center ${
                      resident.balance > 0 ? 'text-red-400' : 'text-emerald-400'
                    }`}>
                      <IndianRupee className="w-3 h-3" />{resident.balance}
                    </p>
                  </div>
                </div>

                <div className={`mt-2 text-center text-xs font-medium ${
                  resident.paymentStatus === 'paid' ? 'text-emerald-400' :
                  resident.paymentStatus === 'pending' ? 'text-amber-400' : 'text-red-400'
                }`}>
                  {resident.paymentStatus.toUpperCase()}
                </div>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div className="grid grid-cols-2 gap-3">
            ...
            <Input label="Mobile" value={form.mobile} onChange={(v) => update('mobile', v)} required />
          </div>
